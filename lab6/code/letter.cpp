...
const GLfloat letter::vertexData[vertices][3] = {
    ...
    {0.25f, 0.75f, 0},//8
    {0.25f, 0.75f, 0.25f},//9
    {0.75f, 0.75f, 0.25f},//10
    {0.75f, 0.75f, 0},//11

    {0.25f, 0.25f, 0},//12
    {0.25f, 0.25f, 0.25f},//13

    {0.75f, 0.25f, 0.25f},//14
    {0.75f, 0.25f, 0},//15
    {0.25f, 1.0f, 0},//16
    {0.25f, 1.0f, 0.25f},//17
    {0.25f, 0, 0},//18
...
void letter::getIndexArray()
{
    ...
    setQuad(4, 8, 9, 10, 11);
    setQuad(5, 8, 9, 13, 12);
    setQuad(6, 12, 13, 14, 15);
    setQuad(7, 15, 14, 2, 3);
    setQuad(8, 16, 8, 11, 7);
    setQuad(9, 17, 9, 10, 6);
    setQuad(10, 4, 16, 18, 0);
    setQuad(11, 5, 17, 19, 1);
    setQuad(12, 12, 18, 3, 15);
    setQuad(13, 13, 19, 2, 14);
}
